...
public class ActionBarDrawerToggle extends
	...
	public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout,
			DrawerArrowDrawable drawerImage, int openDrawerContentDescRes,
			int closeDrawerContentDescRes) {
		super(activity, drawerLayout, R.drawable.ic_launcher,
	...
	public void onDrawerSlide(View drawerView, float slideOffset) {
		...
		if (animateEnabled) {
			mDrawerImage.setVerticalMirror(!mDrawerLayout
	...
	protected void setActionBarUpIndicator() {
		if (mActivity != null) {
			try {
				Method setHomeAsUpIndicator = ActionBar.class
						.getDeclaredMethod("setHomeAsUpIndicator",
								Drawable.class);
